...
###### If I get an error while registration


If you are redirected to the error page it means we had trouble creating a file your container and should the rights to the app.
